...
<table class="table table-striped table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class='text-center'><?= $row->buy_number ?></td>
            <td class='text-center'><?= $row->buy_reference ?></td>
            <td><?= $row->supplier_name ?></td>
            <td class='text-center'><?= date("d-m-y",strtotime($row->buy_date)) ?></td>
            <td class='text-right'><?= $row->item_quantity ?> <?= $row->material_unit ?></td>
